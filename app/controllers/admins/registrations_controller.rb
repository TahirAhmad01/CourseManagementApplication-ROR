...
class Admins::RegistrationsController < Devise::RegistrationsController
  ...
  def configure_permitted_parameters_for_admin
    devise_parameter_sanitizer.permit(:sign_up, keys: [:first_name, :last_name, :admin_profile_picture, :gender])
    devise_parameter_sanitizer.permit(:account_update, keys: [:first_name, :last_name, :admin_profile_picture, :gender])
  end
