...
class EnrolledCoursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enrolled_course" do
    assert_difference("EnrolledCourse.count") do
      post enrolled_courses_url, params: { enrolled_course: { course_id: @enrolled_course.course_id, semester_id: @enrolled_course.semester_id, users_id: @enrolled_course.users_id } }
    end
  ...
  test "should update enrolled_course" do
    patch enrolled_course_url(@enrolled_course), params: { enrolled_course: { course_id: @enrolled_course.course_id, semester_id: @enrolled_course.semester_id, users_id: @enrolled_course.users_id } }
